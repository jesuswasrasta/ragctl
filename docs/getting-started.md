# Getting Started with ragctl

Quick guide to get started with ragctl CLI.
...
```bash
# Create a test file
echo "This is a test document for ragctl. It will be chunked into smaller pieces for RAG applications." > test.txt
